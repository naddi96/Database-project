...
i= 1
stri = "INSERT into art(titolo,testo,utenteID) values "
while (i < 200001):
    for k in range(1,random.randint(1,5)):
        art='art'+''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(6))
        stri=stri+"('{}','{}',{}),".format(art,art+" Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatu",i)
    i=i+1
stri=stri[:-1]+';'
print('inserimento')
cur.execute(stri)
